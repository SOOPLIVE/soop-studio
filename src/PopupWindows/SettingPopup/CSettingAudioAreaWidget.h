...
public:
	...
	bool CheckAudioRestartRequired() { return m_restartNeeded; }

	void SetAudioDataChangedVal(bool changed) {m_audioDataChanged = changed; };
	bool AudioDataChanged() { return m_audioDataChanged; };
	int AudioBitrate();
...
private:
	...
	bool m_audioDataChanged = false;
	bool m_restartNeeded = false;

	int m_sampleRateIndex = 0;
	int m_channelIndex = 0;
	bool m_llBufferingEnabled = false;

	int m_lastChannelSetupIdx = 0;
