...
bool AFUIValidation::NoSourcesConfirmation(QWidget *parent)
{
...
StreamSettingsAction AFUIValidation::StreamSettingsConfirmation(QWidget *parent, OBSService service)
{
	...
	char const *streamUrl = obs_service_get_connect_info(service,
														 OBS_SERVICE_CONNECT_INFO_SERVER_URL);
	char const *streamKey = obs_service_get_connect_info(service,
