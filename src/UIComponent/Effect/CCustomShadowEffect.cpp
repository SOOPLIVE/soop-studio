...
AFCustomShadowEffect::AFCustomShadowEffect(QObject* parent) :
...
void AFCustomShadowEffect::draw(QPainter* painter)
{
...
QRectF AFCustomShadowEffect::boundingRectFor(const QRectF& rect) const
{
